...
class mujoco_ros:
    ...
    def __init__(self,actuators):
        ...
        self.joint_angles=[]
        self.subscriber_fn(actuators)

    def callback(self, data, joint): 
        self.joint_angles.append(data.data)
        print(joint, "       ", data.data)      # For test

    def subscriber_fn(self, actuators):
...
def controller(model, data):
    ...
    print("######################################################################################################")    
    print(node.joint_angles)
    print("######################################################################################################")    

    # Assign joint values to joints in mujoco
    if len(node.joint_angles) == len(actuator_names):
...
# Initialize ROS
node = mujoco_ros(actuator_names) 
